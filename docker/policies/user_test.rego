...
test_failUserCount_empty {
  failUserCount with input as {"stages": {"foo":[
    {"Cmd": "user", "Value": []}
  ]}}
}
...
test_failUserCount_not_empty {
  not failUserCount with input as {"stages": {"foo":[
...
test_failLastUserRoot_is_root {
  failLastUserRoot with input as {"stages": {"foo":[
...
test_failLastUserRoot_not_root {
  not failLastUserRoot with input as {"stages": {"foo":[
