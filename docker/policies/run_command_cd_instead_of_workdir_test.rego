...
test_basic_denied {
	...
	count(r) == 1
	r[_] == "RUN shouldn't be used to change directory: 'cd /usr/share/nginx/html'. Use 'WORKDIR' statement instead."
}
...
test_chaining_denied {
	...
	count(r) == 1
	r[_] == "RUN shouldn't be used to change directory: 'apt-get install vim && cd /usr/share/nginx/html'. Use 'WORKDIR' statement instead."
}
